...
if __name__== '__main__':
    ...
    for run in range(len(runs)):
        ...
        for robot_name in runs[run]:
           ...
           # 
            ...
            print "%s\ttime:\t%f\tdist:\t%f\tavg_loc_error:\t %f\tcost_jerk_ang: %f"%(robot_name, time, distance, avg_loc_error, cost_jerk_ang)
    ...
    print "-" * 80
    print "#robots: %d\nlocalization: %s\n#runs: %d\ncollisions: %d in\t%d runs\ncollisions_res: %d in \t%d\n#runs exceeded time=: %d\n#runs out of box: %d\n#runs not started: %d\n#runs small jerk: %d\navg max time: %f\t%f\navg distance: %f\t%f\navg-jerk-lin-cost: %f\t%f\navg-jerk-ang-cost: %f\t%f\nloc-err: %f\t%f"%(num_robots, str(localization), run_count, coll_total,coll_runs,coll_res_total,coll_resolved_runs, exceeded_count, out_of_box_count, not_started_count, small_jerk_count, time_max_avg, time_max_std, distance_avg, distance_std, jerk_lin_avg, jerk_lin_std, jerk_ang_avg, jerk_ang_std, loc_err_avg, loc_err_std)
    #    print stall
